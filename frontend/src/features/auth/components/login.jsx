                ...
                <div className="w-full max-w-md space-y-8 px-4 auth bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-600 text-2xl font-bold sm:text-3xl text-center">Login</h3>
                            <p className="text-center">Didn't signed up yet? <Link to="/signup" href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500">Sign Up</Link></p>
                        </div>
                    </div>
