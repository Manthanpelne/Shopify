    ...
    <div>
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen lg:flex">
               <img className="h-full border-black" src="https://i.pinimg.com/564x/29/65/46/2965467d65f2b58cf3fe3f810a0581c8.jpg" alt="" />
            </div>
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white auth text-gray-600 sm:px-0">
                    <div className="">
                        <h1 className="lg:hidden text-2xl font-bold text-center bg-slate-400 h-24 pt-7">SHOPIFY</h1>
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl text-center">Sign up</h3>
                            <p className="text-center">Already have an account? <Link to="/login" href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500">Log in</Link></p>
                        </div>
                    </div>
                    <div className="relative">
                        <span className="block w-full h-px bg-gray-500"></span>
                        <p className="inline-block w-fit bg-gray-100 text-sm px-2 absolute -top-2 inset-x-0 mx-auto">Sign Up using</p>
                    </div>
                    ...
                    >
                        ...
                        <button
                            className="w-full px-4 py-2 text-white font-medium bg-gray-800 hover:bg-black active:bg-gray-600 rounded-lg duration-150"
                        >
                            Create account
                        </button>
                    </form>
