    ...
    return (
        ...
        onSubmit={handleSubmit((data) => {
         ...
         className="lg:w-3/5 m-auto">
          <div className="space-y-12 bg-white px-10">
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            ...
            {selectedProduct && <button onClick={handleDelete} type="button" className="text-sm font-semibold leading-6 text-gray-900">
            Delete
            </button>}
            <button
              type="submit"
