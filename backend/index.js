...
app.use(
  cors({
    ...
    origin:"https://663c9bceea36e5978746ff08--lighthearted-paprenjak-ada158.netlify.app",
    credentials:true,
    preflightContinue: true
  })
);
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "https://663c9bceea36e5978746ff08--lighthearted-paprenjak-ada158.netlify.app");
